...
/***********
 * FIXME: although generally working, the sidebar toggle button colour,
 * and the placement of the header text are not perfect
 * - the header text should take in to account the width of the sidebar
 * - the sidebar title is showing even when collapsed
 * - the sidebar toggle button bg should match the header bg
 *
 */
import {
  Tooltip,
...
export function ResponsiveSidebarWithMobile({
  isOpen,
  setIsOpen,
  ...
  return (
    <TooltipProvider delayDuration={120}>
      ...
      {/* Sidebar */}
      <aside
        className="fixed top-0 left-0 h-full bg-gray-900 text-white z-60
      ...
      >
        ...
        <div className="relative h-16 flex items-center border-b border-gray-700 flex-shrink-0">
          ...
          <span className="ml-12 font-bold text-lg whitespace-nowrap">
            MyApp
          </span>
        </div>
